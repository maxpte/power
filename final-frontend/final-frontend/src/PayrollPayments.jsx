...
const PayrollPayments = () => {
  ...
  const currencySymbol = CURRENCY_SYMBOLS[accountDetails?.currency || filters.paymentCurrency || "INR"];
  ...
  const filteredBatches = batchGrid
    .filter((b) => b.currency === (accountDetails?.currency || filters.paymentCurrency || "INR"))
