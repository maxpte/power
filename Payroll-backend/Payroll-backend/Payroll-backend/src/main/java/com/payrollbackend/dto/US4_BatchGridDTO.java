 ...
 * Independent DTO for batch grid display in US4
 */
public class US4_BatchGridDTO {
    ...
    public US4_BatchGridDTO() {}

    public US4_BatchGridDTO(String batchReference, String createdBy, LocalDateTime createdAt, int numberOfPayments, Double maxDebitAmount, Double totalDebitAmount, String status, String currency, String debitAccountNumber) {
