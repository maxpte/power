...
// Used in User Story 3 (Payroll Creation) and User Story 4 (Batch Summary)
public class US3_PayrollBatchGridDTO {
    ...
    public US3_PayrollBatchGridDTO() {}

    public US3_PayrollBatchGridDTO(String batchReference, String createdBy, LocalDateTime createdAt, int numberOfPayments, Double maxDebitAmount, Double totalDebitAmount, String status, String currency, String debitAccountNumber) {
